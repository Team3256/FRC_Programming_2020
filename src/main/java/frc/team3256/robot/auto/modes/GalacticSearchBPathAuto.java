...
public class GalacticSearchBPathAuto extends AutoModeBase {

    GalacticSearchPathSelection g = GalacticSearchPathSelection.getInstance();
...
//        if(g.isRed(false)){
        ...
        if(g.isRed(false)){
            purePursuitTracker.setPaths(Paths.getRedGalacticSearchPathB(), 13);
        } else {
            purePursuitTracker.setPaths(Paths.getBlueGalacticSearchPathB(), DriveConstants.lookaheadDistance);
        }
