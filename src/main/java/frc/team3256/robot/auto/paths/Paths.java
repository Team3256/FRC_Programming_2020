...
public class Paths {
    ...
    public static List<Path> getSlalomPath() {
        ...
        s.addPoint(new Vector(-68.21793728127354, -30.713168187744436));
        s.addPoint(new Vector(-68.21793728127354, -40.713168187744436));
        s.addPoint(new Vector(-68.21793728127354, -50.713168187744436));
        s.addPoint(new Vector(-68.21793728127354, -60.713168187744436));
        s.addPoint(new Vector(-68.21793728127354, -70.713168187744436));
        s.addPoint(new Vector(-68.21793728127354, -80.713168187744436));
        s.addPoint(new Vector(-68.21793728127354, -90.713168187744436));
