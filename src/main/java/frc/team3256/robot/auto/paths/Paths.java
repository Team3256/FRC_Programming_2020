...
//        s.addPoint(new Vector(-66.85296618340878, 209.0199008889789));
    ...
    public static List<Path> getRedGalacticSearchPathB(){
        ...
        s.addPoint(new Vector(-20.498047846352236, 168.4531638583002));
        s.addPoint(new Vector(-22.35180136637591, 173.05827177324412));
        s.addPoint(new Vector(-24.10467360636774, 178.40839370216707));
        s.addPoint(new Vector(-24.21682496438622, 184.0976813309476));
        s.addPoint(new Vector(-24.093269749504614, 189.79693279860186));
        s.addPoint(new Vector(-24.646060898922045, 195.69290087500625));
        s.addPoint(new Vector(-24.85448426444512, 201.60801557480667));
        s.addPoint(new Vector(-24.814601024690035, 207.59288170569135));
        s.addPoint(new Vector(-24.583790974659635, 213.5989669051261));
        s.addPoint(new Vector(-24.203433016741855, 219.57322100944083));
        s.addPoint(new Vector(-24.71356242511705, 225.59229009142658));
        s.addPoint(new Vector(-24.13304845022553, 231.62939692066382));
        s.addPoint(new Vector(-24.4774141142331, 237.67754036715988));
        s.addPoint(new Vector(-24.75902960311298, 243.74406974684908));
        s.addPoint(new Vector(-24.984734724851464, 249.7619801317044));
        s.addPoint(new Vector(-25.165809711607395, 255.83209687579452));
        s.addPoint(new Vector(-25.30598274583882, 261.88870641716073));
        s.addPoint(new Vector(-25.41082140802406, 267.9420178789631));
        s.addPoint(new Vector(-25.48490166483633, 273.99007867598556));
        s.addPoint(new Vector(-25.53244119195348, 280.01440641198167));
        s.addPoint(new Vector(-25.55810527384192, 286.04288825279065));
        s.addPoint(new Vector(-25.56676486097858, 292.06663463027104));
        s.addPoint(new Vector(-25.56452238169045, 298.15764099053314));
        s.addPoint(new Vector(-25.559156458804225, 304.18229590735245));
        s.addPoint(new Vector(-25.557228515096014, 310.2149386092931));
        s.addPoint(new Vector(-25.55722695181221, 310.74237104817126));
    ...
    public static List<Path> getBlueGalacticSearchPathB(){
        ...
        s.addPoint(new Vector(-15.966126560426872, 204.2107414539584));
        s.addPoint(new Vector(-15.283784182587112, 210.21442472978873));
        s.addPoint(new Vector(-15.60823364565094, 216.1874577185803));
    ...
    public static List<Path> getSlalomPath() {
        ...
        s.addPoint(new Vector(-78.56452121437347, 147.3914400080538));
        s.addPoint(new Vector(-78.48940803992816, 153.41510383880475));
        s.addPoint(new Vector(-78.24598370208514, 159.4647540353651));
        s.addPoint(new Vector(-77.74624590553837, 165.49889156295873));
        s.addPoint(new Vector(-76.91462961554993, 171.47796685980435));
        s.addPoint(new Vector(-75.68929735584692, 177.36481254492324));
        s.addPoint(new Vector(-73.99510709348056, 183.20927788287395));
        s.addPoint(new Vector(-71.81572424738982, 188.8884395470828));
        s.addPoint(new Vector(-69.17836168003433, 194.29758031294705));
        s.addPoint(new Vector(-66.05763873814946, 199.49734392744026));
        s.addPoint(new Vector(-62.52678699945501, 204.40056327668918));
        s.addPoint(new Vector(-58.63713791570524, 209.00539087820408));
        s.addPoint(new Vector(-54.45071213963669, 213.3144351953034));
        s.addPoint(new Vector(-49.97360507570781, 217.38968700273244));
        s.addPoint(new Vector(-45.2775741049812, 221.22946185894483));
        s.addPoint(new Vector(-40.445354321175245, 224.83632478812854));
        s.addPoint(new Vector(-35.50333946795699, 228.2609389581571));
        s.addPoint(new Vector(-30.430673043700125, 231.58482105731724));
        s.addPoint(new Vector(-25.30783286600615, 234.83218661455658));
        s.addPoint(new Vector(-20.15633522555237, 238.09282818260976));
        s.addPoint(new Vector(-15.070639410095993, 241.4680116841172));
        s.addPoint(new Vector(-10.27276582009685, 245.10179989639948));
        s.addPoint(new Vector(-6.0793156786960765, 249.40490698090554));
        s.addPoint(new Vector(-3.3560210066587217, 254.80398284804676));
        s.addPoint(new Vector(-1.8425731139211052, 260.6350448355159));
        s.addPoint(new Vector(-1.2642797538597108, 266.6423907039051));
        s.addPoint(new Vector(-2.202432833752198, 272.6162589117937));
        s.addPoint(new Vector(-4.511297379593657, 278.15585354975536));
        s.addPoint(new Vector(-7.918810390731238, 283.1655211904691));
        s.addPoint(new Vector(-12.1483497340204, 287.4521928713647));
        s.addPoint(new Vector(-17.075949362846416, 290.8983046260908));
        s.addPoint(new Vector(-22.62759650879758, 293.2803807738077));
        s.addPoint(new Vector(-28.604375298400413, 294.2807279335743));
        s.addPoint(new Vector(-34.64615124532072, 293.87540825564196));
        s.addPoint(new Vector(-40.64839825349148, 292.7747108104828));
        s.addPoint(new Vector(-46.46569751953801, 290.9542039988846));
        s.addPoint(new Vector(-51.855082861785874, 288.2072651432287));
        s.addPoint(new Vector(-56.794751273202465, 284.732119467243));
        s.addPoint(new Vector(-61.2919372071087, 280.6675292265453));
        s.addPoint(new Vector(-65.2359219412943, 276.1385360037402));
        s.addPoint(new Vector(-68.52007171901737, 271.10184615247624));
        s.addPoint(new Vector(-70.76455620227352, 265.497130541677));
        s.addPoint(new Vector(-71.0196420126127, 259.4042675117221));
        s.addPoint(new Vector(-68.19076216332292, 254.0065381091298));
        s.addPoint(new Vector(-63.44918601155675, 250.1467574931171));
        s.addPoint(new Vector(-58.33881361061934, 246.8757336300705));
        s.addPoint(new Vector(-52.94140812579715, 244.07082331239803));
        s.addPoint(new Vector(-47.28726495941868, 242.0090582487416));
        s.addPoint(new Vector(-41.40963923448085, 240.5733478939532));
        s.addPoint(new Vector(-35.44172756742907, 239.5579302114905));
        s.addPoint(new Vector(-29.446649633103476, 238.69990257543907));
        s.addPoint(new Vector(-23.441311765784405, 237.64906428053496));
        s.addPoint(new Vector(-17.666391821132493, 235.81024002106517));
        s.addPoint(new Vector(-12.848333849677857, 232.18073066208956));
        s.addPoint(new Vector(-9.361062282430083, 227.2861270735906));
        s.addPoint(new Vector(-4.509761031164032, 223.6850690882693));
        s.addPoint(new Vector(-0.25074668224365837, 219.3722131438497));
        s.addPoint(new Vector(1.4619941444058497, 213.56424977532285));
        s.addPoint(new Vector(2.3933191683906045, 207.570771146732));
        s.addPoint(new Vector(2.9874758952106504, 201.5758542507673));
        s.addPoint(new Vector(3.4004953697909173, 195.51239592526568));
        s.addPoint(new Vector(3.6910309747457006, 189.5119970018916));
        s.addPoint(new Vector(3.90312547647045, 183.4230616935415));
        s.addPoint(new Vector(4.05316303872371, 177.42111518963216));
        s.addPoint(new Vector(4.160737635759915, 171.3415352661816));
        s.addPoint(new Vector(4.234564204621137, 165.27730593912725));
        s.addPoint(new Vector(4.283537014472415, 159.19857263113587));
        s.addPoint(new Vector(4.314196573639293, 153.17483925495327));
        s.addPoint(new Vector(4.3330090876569045, 147.15021128682426));
        s.addPoint(new Vector(4.345657173746247, 141.06039720881));
        s.addPoint(new Vector(4.35107156753395, 134.96339141404337));
        s.addPoint(new Vector(4.314501626776121, 128.91272782951214));
        s.addPoint(new Vector(4.191738463147857, 122.83668553710547));
        s.addPoint(new Vector(3.9405076027300936, 116.78483848340937));
        s.addPoint(new Vector(3.5117986750997545, 110.69455547448604));
        s.addPoint(new Vector(2.858141703582504, 104.625951426933));
        s.addPoint(new Vector(1.933934139870047, 98.64020454273506));
        s.addPoint(new Vector(0.6742895270140252, 92.7036911171856));
        s.addPoint(new Vector(-0.9721448374502017, 86.89489068397717));
        s.addPoint(new Vector(-3.082972928467001, 81.21073869975739));
        s.addPoint(new Vector(-5.706657886466871, 75.74637168372779));
        s.addPoint(new Vector(-8.874462217870018, 70.58926616516803));
        s.addPoint(new Vector(-12.593846674394655, 65.81313295748328));
        s.addPoint(new Vector(-16.789772258367776, 61.51939000512699));
        s.addPoint(new Vector(-21.45099314573477, 57.67278664766829));
        s.addPoint(new Vector(-26.42762717357543, 54.30534372083136));
        s.addPoint(new Vector(-31.696964583230553, 51.30582771177275));
        s.addPoint(new Vector(-37.083666458920064, 48.61584253733241));
        s.addPoint(new Vector(-42.608524879249785, 46.02027173147408));
        s.addPoint(new Vector(-48.00431333567384, 43.3452102613532));
        s.addPoint(new Vector(-53.118857956969805, 40.14261940146014));
        s.addPoint(new Vector(-57.32813634984758, 35.82620650560585));
        s.addPoint(new Vector(-59.87835472125673, 30.330223744302373));
        s.addPoint(new Vector(-61.559529242660645, 24.562095477039307));
        s.addPoint(new Vector(-63.106019083773276, 18.718430159539224));
        s.addPoint(new Vector(-64.46124419533899, 12.836045423488834));
        s.addPoint(new Vector(-65.64611631580753, 6.941529577673833));
        s.addPoint(new Vector(-66.70043053563518, 1.0156215566216247));
        s.addPoint(new Vector(-67.65884343695053, -4.998044287204067));
        s.addPoint(new Vector(-68.52028395828735, -10.984667888206687));
        s.addPoint(new Vector(-69.30086518651926, -16.976590558358822));
        s.addPoint(new Vector(-70.00423895460082, -22.978423707614063));
        s.addPoint(new Vector(-70.62169879267945, -28.987558575215324));
        s.addPoint(new Vector(-71.10775429328069, -34.974903157112244));
        s.addPoint(new Vector(-71.26265783222897, -38.672334041755235));
    ...
    public static List<Path> getBarrelRacingPath() {
        ...
        s.addPoint(new Vector(4.21375524701331, -100.015175976751465));
